...
Meant to use React Profiler here, to clearly see which components are being re-rendered.

[React.memo's second argument is a function call](https://reactjs.org/docs/react-api.html#reactmemo) with `prevProps`
and `nextProps` which is a plain object of each props. KCD does a compare on each prop and a similar comparison of 
highlightedIndex as I did. I just did a short circuit.  It's not clear if I had any bugs in my version,
though it did appear to work fine.

Extra 2 makes way more sense, and is a pattern I have already used. Good to know.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Performance%20%E2%9A%A1&e=03%3A%20React.memo%20for%20reducing%20unnecessary%20re-renders&em=ashley.bartlett%40gmail.com).
